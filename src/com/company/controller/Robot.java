...
//to manage the robot’s functionality
public class Robot {
...
//         */
    private int[] calcSensorActions(int[] sensorActionsStr) { // How many actions are there? 
...
// If sensor value has already been calculated
        ...
        // Calculate sensor value int sensorVal = 0;
        if (frontSensor == true) {
            sensorVal += 1;
        }
